...
Route::get('feedback/GetClient', [FeedbackController::class, 'GetClient']);
Route::get('feedback/GetShipping', [FeedbackController::class, 'GetShipping']);
Route::get('FeedbackByShippingCompanyId/{id}', [feedbackController::class, 'FeedbackByShippingCompanyId']);
Route::get('FeedbackByClientId/{id}', [feedbackController::class, 'FeedbackByClientId']);
